...
- Create Angular project with ng: `ng new currencyconverterapp.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`currencyconverterapp.client.esproj`).
